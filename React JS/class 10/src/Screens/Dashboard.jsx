    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <Routes>
          ...
          <Route path="users_dashboard" element={<Users />} />
          <Route path="projects_dashboard" element={<Projects />} />
          <Route path="developers_dashboard" element={<Developers />} />
        </Routes>
      </Box>
    </Box>
  );
